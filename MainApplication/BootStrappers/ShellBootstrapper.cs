...
using MainApplication.Modules;

namespace MainApplication.Shell
{
    class ShellBootstrapper : UnityBootstrapper
    {
        ...
        protected override void ConfigureModuleCatalog()
        {
            ...
            //系统模块直接加载
            ModuleCatalog.AddModule(new ModuleInfo(WellKnownModuleNames.AppToolBarModule, typeof(AppToolBarModule).AssemblyQualifiedName));
